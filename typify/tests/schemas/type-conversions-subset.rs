...
pub struct ConversionHolder {
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub price: ::std::option::Option<::serde_json::Number>,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
...
#[serde(transparent)]
pub struct Sku(pub ::std::string::String);
...
impl ::std::convert::From<::std::string::String> for Sku {
...
pub mod builder {
    ...
    pub struct ConversionHolder {
        ...
        price: ::std::result::Result<
            ::std::option::Option<::serde_json::Number>,
            ::std::string::String,
        >,
    ...
    impl ConversionHolder {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<::serde_json::Number>>,
            T::Error: ::std::fmt::Display,
        {
            self.price = value
                .try_into()
